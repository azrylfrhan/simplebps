@extends('layouts.app', ['bodyClass' => 'login-page-body', 'title' => 'Login'])
...
<div class="login-container">
    <div class="mb-5">
        <img src="{{ asset('image/logoBps.png') }}" alt="Logo BPS" class="login-logo" style="width: 90px;">
    ...
    <div class="footer-text">
        &copy; {{ date('Y') }} Badan Pusat Statistik<br>
