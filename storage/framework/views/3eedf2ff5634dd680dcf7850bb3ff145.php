...
<div class="container-fluid py-4">
    ...
    <form action="<?php echo e(route('konfigurasi.update')); ?>" method="POST">
        <?php echo csrf_field(); ?>
            ...
            <div class="col-12">
                <div class="config-card p-4">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-8">
                            <input type="text" name="tempat_ttd" class="form-control" value="<?php echo e($config['tempat_ttd'] ?? 'Manado'); ?>" placeholder="Contoh: Manado" style="color: var(--deep-blue);">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="config-card overflow-hidden">
                    ...
                    <div class="config-body p-4">
                        <div class="mb-3">
                            ...
                            <input type="text" name="jabatan_spkl" class="form-control" value="<?php echo e($config['jabatan_spkl'] ?? ''); ?>" placeholder="Contoh: Kuasa Pengguna Anggaran">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Nama Lengkap & Gelar</label>
                            <input type="text" name="nama_spkl" class="form-control" value="<?php echo e($config['nama_spkl'] ?? ''); ?>" style="color: var(--deep-blue);">
                        </div>
                        <div>
                            <label class="form-label">Custom Tanggal (Opsional)</label>
                            <input type="text" name="tgl_spkl_manual" class="form-control" value="<?php echo e($config['tgl_spkl_manual'] ?? ''); ?>" placeholder="Contoh: 15 Agustus 2025">
            ...
            <div class="col-md-6">
                <div class="config-card overflow-hidden">
                    ...
                    <div class="config-body p-4">
                        <div class="mb-3">
                            <label class="form-label">Jabatan</label>
                            <input type="text" name="jabatan_rekap" class="form-control" value="<?php echo e($config['jabatan_rekap'] ?? ''); ?>" placeholder="Contoh: Ketua Tim SDM">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Nama Lengkap & Gelar</label>
                            <input type="text" name="nama_rekap" class="form-control" value="<?php echo e($config['nama_rekap'] ?? ''); ?>" style="color: var(--deep-blue);">
                        </div>
                        <div>
                            <label class="form-label">Custom Tanggal (Opsional)</label>
                            <input type="text" name="tgl_rekap_manual" class="form-control" value="<?php echo e($config['tgl_rekap_manual'] ?? ''); ?>" placeholder="Contoh: 15 Agustus 2025">
                            <div class="form-text x-small mt-2"><i class="fas fa-question-circle"></i> Kosongkan jika ingin menggunakan tanggal hari ini secara otomatis.</div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\project_magang\resources\views/konfigurasi/index.blade.php ENDPATH**/ ?>