                ...
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-hover align-middle mb-0">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $tim; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td class="ps-4">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="fw-bold text-dark"><?php echo e($t->nama_tim); ?></div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="text-muted small">
                                            <i class="fas fa-user-tie me-1 opacity-50"></i>
                                            <?php echo e($t->ketua_tim ?? 'Belum Ditentukan'); ?>

                                        </div>
                                    </td>
                                    <td class="text-end pe-4">
                                        <div class="btn-group shadow-sm rounded-3 overflow-hidden border">
                                            <button class="btn btn-white btn-sm px-3 border-end" data-bs-toggle="modal" data-bs-target="#editModal-<?php echo e($t->id); ?>" title="Edit">
                                                <i class="fas fa-edit text-warning"></i>
                                            </button>
                                            <form action="<?php echo e(route('tim.destroy', $t->id)); ?>" method="POST" class="d-inline" onsubmit="return confirm('Hapus tim <?php echo e($t->nama_tim); ?>? Pegawai di tim ini akan menjadi tanpa tim.');">
                                ...
                                <div class="modal fade" id="editModal-<?php echo e($t->id); ?>" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content border-0 shadow-lg" style="border-radius: 15px;">
                                            ...
                                            <form action="<?php echo e(route('tim.update', $t->id)); ?>" method="POST">
                                                <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
                                                <div class="modal-body p-4">
                                                    <div class="mb-3">
                                                        <label class="form-label small fw-bold text-muted text-uppercase">Nama Tim</label>
                                                        <input type="text" name="nama_tim" value="<?php echo e($t->nama_tim); ?>" class="form-control border-soft bg-light" required>
                                                    </div>
                                                    <div class="mb-0">
                                                        <label class="form-label small fw-bold text-muted text-uppercase">Ketua Tim</label>
                                                        <input type="text" name="ketua_tim" value="<?php echo e($t->ketua_tim); ?>" class="form-control border-soft bg-light">
                                                    </div>
                                                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\project_magang\resources\views/tim/index.blade.php ENDPATH**/ ?>