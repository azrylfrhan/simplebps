                            ...
                            <tr>
                                <td class="ps-4">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="fw-bold text-dark"><?php echo e($p->nama_lengkap); ?></div>
                                    </div>
                                </td>
                                <td><span class="small text-muted"><?php echo e($p->jabatan); ?></span></td>
                                <td>
                                    <?php if($p->tim_id): ?>
                                        <span class="badge px-3 py-2 rounded-pill" style="background-color: #e6f0f5; color: #004a69;">
                                            <i class="fas fa-tag me-1 small"></i> <?php echo e($p->tim->nama_tim); ?>
                                ...
                                <td class="text-end pe-4">
                                    <div class="btn-group shadow-sm rounded-3 overflow-hidden border">
                                        <button class="btn btn-white btn-sm px-3 border-end" data-bs-toggle="modal" data-bs-target="#editModal-<?php echo e($p->id); ?>" title="Ubah Data">
                                            <i class="fas fa-edit text-warning"></i>
                                        </button>
                                        <button class="btn btn-white btn-sm px-3" data-bs-toggle="modal" data-bs-target="#hapusModal-<?php echo e($p->id); ?>" title="Hapus">
        ...
        <div class="modal-content border-0 shadow-lg" style="border-radius: 15px;">
            ...
            <div class="modal-body p-4">
                <div class="mb-4">
                    ...
                    <a href="<?php echo e(route('pegawai.template')); ?>" class="btn btn-outline-success w-100 fw-bold" style="border-radius: 10px; border-style: dashed;">
    ...
    <div class="modal fade" id="editModal-<?php echo e($p->id); ?>" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg" style="border-radius: 15px;">
                ...
                <form action="<?php echo e(route('pegawai.update')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="modal-body p-4">
                        <input type="hidden" name="id" value="<?php echo e($p->id); ?>">
                        <div class="mb-3">
                            <label class="form-label small fw-bold text-muted text-uppercase">Nama Lengkap</label>
                            <input type="text" class="form-control border-soft bg-light" name="nama_lengkap" value="<?php echo e($p->nama_lengkap); ?>" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label small fw-bold text-muted text-uppercase">Jabatan</label>
                            <input type="text" class="form-control border-soft bg-light" name="jabatan" value="<?php echo e($p->jabatan); ?>" required>
                        </div>
                        <div class="mb-0">
                            ...
                            <select class="form-select border-soft bg-light" name="tim_id">
                                ...
                                <?php $__currentLoopData = $tim; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($t->id); ?>" <?php echo e($t->id == $p->tim_id ? 'selected' : ''); ?>><?php echo e($t->nama_tim); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm">
            <div class="modal-content border-0 shadow-lg" style="border-radius: 15px;">
                <div class="modal-body p-4 text-center">
                    ...
                    <p class="mb-4 small">Hapus data <b><?php echo e($p->nama_lengkap); ?></b>?</p>
                    <div class="d-flex gap-2">
                        <button type="button" class="btn btn-light w-100 rounded-pill" data-bs-dismiss="modal">Batal</button>
                        <form action="<?php echo e(route('pegawai.delete')); ?>" method="POST" class="w-100">
                            <?php echo csrf_field(); ?>
                            <input type="hidden" name="id" value="<?php echo e($p->id); ?>">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\PENGOLAHAN2-SP2020\Downloads\al magang\Project\project-magang\resources\views/pegawai/index.blade.php ENDPATH**/ ?>